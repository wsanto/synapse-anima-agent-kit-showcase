...
LLM provider implementation for Nous Research models (via OpenRouter/compatible APIs).
"""
...
class NousProvider(BaseLLMProvider):
    """Nous Research LLM provider implementation."""
    ...
    def __init__(
        ...
        quick_model_name: str = "nousresearch/hermes-3-llama-3.1-405b:free",
        deep_model_name: str = "nousresearch/hermes-3-llama-3.1-405b",
        temperature: float = 0.7,
        timeout: int = 120,
    ):
        """
        Initialize Nous provider.

        Args:
            api_key: Nous/OpenRouter API key (defaults to NOUS_API_KEY env var)
        ...
        if not self.api_key:
            raise ValueError("Nous API key is required")
        ...
        self.client = httpx.AsyncClient(
            ...
            headers={
                ...
                "HTTP-Referer": "https://github.com/Kaiko-Studios/synapse-anima-agent-kit",
                "X-Title": "Synapse Anima Agent Kit",
            },
